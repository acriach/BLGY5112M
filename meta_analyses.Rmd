...
1) The first choice is standardized mean difference (SMD also known as Cohen's $d$ or Hedge's $d$ or $g$; there are some subtle differences between them, but we do not worry about them for now.
<details>
